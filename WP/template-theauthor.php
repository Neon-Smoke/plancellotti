	...
	<div class="maincontain">
		...
		<div class="about">
			<p style="text-align: left; margin-top: 2.5%; padding-right: 2.5px; padding-bottom: 5%;">
				<img src="<?php bloginfo('template_directory');?>/images/Vampiree.jpg" style="float: right;width: 50%; height: auto; margin-left: 1%; margin-top: 1.5%;">
				...
				<img src="<?php bloginfo('template_directory');?>/images/FB_IMG_1641630526678.jpg" style="float: right; width: 50%;height: auto; margin-left: 5%; margin-bottom: 0.5%; margin-top: 1%">
							...
							<br>
							<br>
							He was always attracted to older people in his life, surrounding himself with those
							smarter than he was because of his innate thirst for knowledge. His original reinvention plan was to make a simple transition from sales and marketing in Cable TV to telehealth. 
							<br>
							As a student of the Davis School of Gerontology at the University of Southern California, Peter worked in scientific research for over four years. Gerontology is the study of aging across the lifespan with an emphasis on older adults. He recruited older adults into a longitudinal study experimenting on the hypothesis of whether Alzheimer's was detectable with our current instrumentation. Peter was not only responsible for recruitment, but also administered cognitive testing.

							<br>

				<img src="<?php bloginfo('template_directory');?>/images/211.JPG" style="float: left; width: 50%; height: auto; margin-right: 5%; margin-bottom: 2.5%; margin-top: 4%">

							<br>

						 	He was in demand by other professors having never worked half-heartedly and was recruited into four other studies he followed through to completion.
							After working as a research assistant, he decided he could help older
							adults in a better capacity by opening his own homecare agency in Los Angeles County. 

							He served the LGBTQ (Lesbian, Gay, Bisexual, Transgender, and Questioning/Queer) older adult demographic, which surprisingly had never been done successfully.
